	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div id="print-section-exit-pass">
	 				<div class="container print-container exit-pass-print-preview">
							...
							<tr>
								...
								<td class="col-xs-3">	
									<div class="row pull-right">
										<div class="col-xs-12">
											<h4 class="text-danger epass-serial-text text-holder preview-field"></h4>
										</div>
									</div>
									...
									<div class="row buffer-top preview-field">
										<div class="col-xs-12">
											<strong>Time Out:</strong>
											<span class="pull-right timeout-text-container text-holder"></span>
										</div>
									</div>
									<div class="row buffer-top">
										<div class="col-xs-12">
			...
			<div class="modal-footer">
				...
				<button id="print-exitpass-btn" type="button" class="btn btn-primary">Print</button>
